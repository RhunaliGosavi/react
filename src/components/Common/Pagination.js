...
class Pagination extends React.Component {
    ...
    render() {
        ...
        return (
            <nav aria-label="..." className="float-right nav-margin">
            <ul className="pagination flex-wrap pagination-style">
                <li className={pager.currentPage === 1 ? 'disabled page-item' : 'page-item'}>
                    <a onClick={() => this.setPage(1)} className="page-link">First</a>
                </li>
                <li className={pager.currentPage === 1 ? 'disabled page-item' : 'page-item'}>
                    <a onClick={() => this.setPage(pager.currentPage - 1)} className="page-link">&laquo;</a>
                </li>
                ...
                <li className={pager.currentPage === pager.totalPages ? 'disabled page-item' : 'page-item'}>
                    <a onClick={() => this.setPage(pager.currentPage + 1)} className="page-link">&raquo;</a>
                </li>
                <li className={pager.currentPage === pager.totalPages ? 'disabled page-item' : 'page-item'}>
