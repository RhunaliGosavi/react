...
class CMPDashboard extends Component {
    constructor(){
        super();
    ...
    componentDidMount=()=>{
		...
		var tableaueDisplayOptions =
		{
          ...
          var data= axios({
                ...
                //tableaueVizURL = part1+response.data+process.env.REACT_APP_TABLEAU_CMP_URL
                tableaueVizURL = process.env.REACT_APP_TABLEAU_BASE_URL+process.env.REACT_APP_TABLEAU_CMP_URL
        ...
        <>
            ...
            <div className="container-fluid main mt-0">
                <div className="row title-row">
                    <h2 className="page-title">CMP Dashboard</h2>
                </div>
            </div>	
                        ...
                        <div className="col-md-12">
                            <nav>
                                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    role="tab" aria-controls="nav-home" aria-selected="true">CMP</a>
                                </div>
                            </nav>
...
export default connect(mapStateToProps)(withRouter(CMPDashboard));
